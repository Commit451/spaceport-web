    ...
    return (
        <main className="main-content">
            <div className="home-content">
                ...
                <p className="app-subtitle">Spaceport - A launch site for apps and experiences</p>

                <div className="cards-container">
                    <a href="https://slicer.spaceport.work/" className="card" target="_blank" rel="noopener noreferrer">
                        <img src={slicerLogo} className="card-icon" alt="Slicer"/>
                ...
                <div className="social-links">
                    ...
                    <a href="https://github.com/Commit451" className="social-link" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                        <svg viewBox="0 0 24 24" fill="currentColor">
